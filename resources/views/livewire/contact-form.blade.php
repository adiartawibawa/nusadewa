<div
    ...
    <h3 class="mb-4 text-xl font-bold text-gray-900 dark:text-white sm:text-2xl">
        {{ __('component.contact_form.title') }}</h3>
    <p class="mb-6 text-base text-gray-600 dark:text-gray-300">
        {{ __('component.contact_form.description') }}
    </p>
    ...
    <form wire:submit.prevent="submit" class="space-y-6">
        ...
        <div class="space-y-4">
            @error('rate_limit')
                <div
                    ...
                    {{ __('component.contact_form.errors.rate_limit') }}
                </div>
            @enderror
            ...
            @error('submit_error')
                <div
                    ...
                    {{ __('component.contact_form.errors.submit_error') }}
                </div>
            @enderror
        </div>
        ...
        <div class="grid gap-6 sm:grid-cols-2">
            ...
            <div>
                <label for="name" class="block mb-2 text-sm font-medium text-gray-700 dark:text-gray-300">
                    {{ __('component.contact_form.fields.name') }} <span class="text-red-500">*</span>
                </label>
            ...
            <div>
                <label for="email" class="block mb-2 text-sm font-medium text-gray-700 dark:text-gray-300">
                    {{ __('component.contact_form.fields.email') }} <span class="text-red-500">*</span>
                </label>
        ...
        <div>
            <label for="subject" class="block mb-2 text-sm font-medium text-gray-700 dark:text-gray-300">
                {{ __('component.contact_form.fields.subject') }} <span class="text-red-500">*</span>
            </label>
        ...
        <div>
            <label for="message" class="block mb-2 text-sm font-medium text-gray-700 dark:text-gray-300">
                {{ __('component.contact_form.fields.message') }} <span class="text-red-500">*</span>
            </label>
        ...
        @if ($success)
            <div x-data="{ show: true }" x-show="show" x-transition x-init="setTimeout(() => show = false, 5000)"
                ...
                {{ __('component.contact_form.submit.success') }}
            </div>
        @endif
        ...
        <button type="submit" wire:loading.attr="disabled"
            ...
            <span wire:loading.remove>{{ __('component.contact_form.submit.button') }}</span>
            <span wire:loading>
                ...
                <span class="sr-only">{{ __('component.contact_form.submit.loading') }}</span>
            </span>
        </button>
    </form>
</div>
