...
<div x-show="sidebarOpen" @click.away="sidebarOpen = false" x-transition:enter="transition ease-out duration-300"
    ...
    aria-modal="true" role="dialog" aria-label="Contact information sidebar">
    <div class="p-6">
        ...
        <div class="mt-16 space-y-8">
            <!-- Company Description -->
            <div>
                <h3 class="mb-4 text-xl font-bold text-gray-900 dark:text-white">Quick Contact Info</h3>
            ...
            <!-- Contact Info -->
            <div>
                <h5 class="font-bold text-gray-800 dark:text-gray-200">CONTACT</h5>
            ...
            <!-- Office Address -->
            <div>
                <h5 class="font-bold text-gray-800 dark:text-gray-200">OFFICE</h5>
            ...
            <!-- Opening Hours -->
            <div>
                <h5 class="font-bold text-gray-800 dark:text-gray-200">OPENING HOURS</h5>
            ...
            @if (isset($appInfo['social_links']))
                <div>
                    <h5 class="font-bold text-gray-800 dark:text-gray-200">FOLLOW US</h5>
